    ...
    <div className="cta-two" >
      <div className="container-fluid">
        <div className="row no-gutters">
          <div className="col-lg-6 thm-base-bg" style={{ position: "relative"}}>
            <div className="cta-two__single" style={{ 
      transform: "scale(.9)",
      position: "absolute",
      top: "50%",
      left: "50%",
      transform: "translate(-50%, -50%)"
              ...
              <div className="cta-two__icon"  style={{ 
      transform: "scale(.9) translateY(90%)"
              ...
              <div className="cta-two__content"  style={{ 
      transform: "scale(.75)"
    }}>
      ...
      transform: "scale(.9)"
              ...
              <div className="cta-two__icon">
                <span>
                  <i className="kipso-icon-knowledge" style={{ 
      transform: "scale(.9)",
    }}></i>
                </span>
              </div>
      ...
      transform: "translate(-50%, -50%)"
                ...
                <h2 className="cta-two__title" style={{ 
      transform: "scale(.7)"
